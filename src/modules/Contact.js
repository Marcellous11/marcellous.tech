...
const Contact = () => {
	useEffect(() => {
		...
		if (window.screen.availWidth < 500) {
			document.querySelector('.Contact-me-headTag').style.marginTop = ' 4rem';
		} else if (window.screen.availWidth > 500 && window.screen.availWidth < 800) {
